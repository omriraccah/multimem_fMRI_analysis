...
def get_labels(preproc_dir, sub, nruns=9):
...
def run_rsa(preproc_dir, sub, roi, nruns, conds, hpc, vis, pos, norm):
    """
    ...
    condlist = get_labels(f"{preproc_dir}/sub-mm{sub}/func/", sub, nruns)
    
    print("PRINTING COND LIST")
...
if __name__ == "__main__":
    ...
    #subs = ["22"]#, "03", "13", "15", "16", "20", "21", "22", "26", "29", "30"]
    #subs = ["02", "03", "13", "15", "16", "20", "21", "22", "26", "29", "30"]
    subs = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", 
    ...
    conditions = ['V-V', 'A-A', 'C-C', 'V-IC_V', 'A-IC_A', 'V-A']  # Always use a - to mark a new condition, has to be a list of interactions.
    ...
    results_path = f"/gpfs/milgram/scratch60/turk-browne/or62/sandbox/RSA_structs/rsa_results_subs_{subs[-1]}_fisher_{fisher}_norm_{norm}_func_{analysis.__name__}_ALL_SUBS_WITHOUT_exclusion_apr15.csv"

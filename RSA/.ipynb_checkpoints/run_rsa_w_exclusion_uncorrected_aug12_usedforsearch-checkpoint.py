...
def extract_betas(sub, preproc_dir, roi, betas, labels, hpc, pos, norm, atlas):
    if hpc:
        if atlas == "ASHS":
            roi_mask = f"{preproc_dir}/sub-mm{sub}/rois/{atlas}/final/func_masks/bin_masks_5B_T1/{pos}_{roi}_mask_T1_non-bin.nii.gz" # CHANGED TO MGGUIRE

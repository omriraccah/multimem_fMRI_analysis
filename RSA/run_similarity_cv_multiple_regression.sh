...
#SBATCH --array=0-29
#SBATCH --output=logs/%j-sim-cv-mr.out
#SBATCH --job-name SIM_CV_MR
#SBATCH -p psych_week
...
/gpfs/milgram/apps/hpc.rhel7/software/dSQ/1.05/dSQBatch.py --job-file /gpfs/milgram/pi/turk-browne/or62/multisensory-memory-project/Similarity_regression/joblist_similarity_cv_multiple_regression.txt --status-dir ./logs

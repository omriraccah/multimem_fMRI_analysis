#!/usr/bin/env bash
#SBATCH --output logs/%j-GLM-beta-analysis_%A_%a.out
#SBATCH --job-name GLM_BETA_ANALYSIS-PP
#SBATCH --array=1-30
...
python "/gpfs/milgram/project/turk-browne/$1/multisensory-memory-project/GLM-condition/glm_beta_analysis.py" -s "$SUBJECT_ID"